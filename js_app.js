// Controller Principal e Orquestrador da Aplicação
let globalData = null;

async function initApp() {
  // 1. Tentar buscar dados dinâmicos do Google Sheets
  const remoteData = await CSVLoader.fetchRemoteData();

  if (remoteData) {
    // Se CSV responder, parse/map
...
function renderDashboard() {
  ...
  // 4. Render Gráficos Fluxo de Caixa
